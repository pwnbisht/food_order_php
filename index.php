<?php include("partials-frontend/menu.php") ?>
    ...
    <section class="categories">
        <div class="container">
            ...
            <?php
                if(isset($_SESSION['cat-food-id']))
                {
                    echo $_SESSION['cat-food-id'];
                    unset($_SESSION['cat-food-id']);
                }
            ...
            <?php
                ...
                if($count>0){
                    ...
                    {
                        //get the values title image_name and id
                        $id = $row['id'];
                        $title = $row['title'];
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php
                ...
                //display food from db that are active and feature
                ...
                if($count2>0){
                    ...
                    //food not available
                    echo "<div class='error'>Food Not Fund </div>";
                }
